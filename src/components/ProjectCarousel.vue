...
<template>
  <div class="relative w-full h-full">
    <div class="relative w-full h-96 bg-zinc-200 dark:bg-zinc-800 rounded-lg overflow-hidden">
      ...
      <div class="absolute left-0 bottom-0 w-full bg-black/70 backdrop-blur-sm text-white px-4 py-3">
    ...
    <div v-if="hasMultiple" class="flex justify-center gap-2 mt-4">
      <button
        ...
        :class="[
          ...
          idx === currentIndex ? 'bg-fuchsia-600 dark:bg-fuchsia-400' : 'bg-zinc-400 dark:bg-zinc-600 hover:bg-zinc-500 dark:hover:bg-zinc-500',
        ]"
